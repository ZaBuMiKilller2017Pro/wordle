...
class WordleGame:
    ...
    def setup_control_buttons(self):
        """Создает кнопки управления игрой"""
        ...
        count_btn.pack(side=tk.LEFT, padx=10)
    ...
    def show_rules(self):
        ...
        rules_text = """
        ПРАВИЛА ИГРЫ WORDLE (Русская версия):

        1. Цель игры: угадать скрытое РУССКОЕ слово из 5 букв
